...
export const sendEmail = async (referrer, invitee, eventClass, res) => {
  ...
  `;
  const masterclass = `<!DOCTYPE html>
                                                      ...
                                                      <table border="0" cellpadding="10" cellspacing="0" class="paragraph_block block-2" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
                                                          <tr>
                                                              <td class="pad">
                                                                  <div style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                                      <p style="margin: 0; ">
                                                                      Exciting news! Thanks to <strong >${referrer}</strong> awesome referral, <strong >${invitee}</strong> has signed up for Joe Cipriano's Online Promo Masterclass! We're thrilled to welcome them to the program.

                                                                      <span style="display:block; padding-top:20px;">As a huge thank you to <strong >${referrer}</strong> for spreading the word, they’ve scored a $50 gift card to our Joe Cipriano Promo Masterclass Merch Store.</span>
                                                                      
                                                                      <span style="display:block; padding-top:20px;">Joe Cipriano will provide you with the unique Promo Code and any details they’ll need to start shopping for FREE Merch. We want to make sure they receive their well-deserved reward ASAP.</span>
